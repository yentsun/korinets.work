...
====================================  =============  ==================
`изготовление сайта "под ключ"`_      от 1 месяца    от :price:`40 000`
`настройка и поддержка веб-сервера`_  1 день         :price:`4 000`
`сбор, анализ и экспорт данных`_      от 2 дней      от :price:`10 000`
`сервис импорта/экспорта данных`_     от 2 недель    от :price:`30 000`
час работы                            1 час          :price:`1000`
====================================  =============  ==================
