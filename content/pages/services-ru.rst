...
====================================  =============  ==================
`изготовление сайта "под ключ"`_      от 1 месяца    от :usd:`2000`
`настройка и поддержка веб-сервера`_  1 день         :usd:`300`
`сбор, анализ и экспорт данных`_      от 2 дней      от :usd:`300`
`сервис импорта/экспорта данных`_     от 2 недель    от :usd:`1000`
разная работа                         1 час          :usd:`20`
====================================  =============  ==================
