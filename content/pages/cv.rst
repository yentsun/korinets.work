...
* планирование, подбор технологий
* автоматизация процессов
* организация рабочего потока и инвентаря
* программирование:

  + ОО (Python)
  + `опыт работы с фреймворками и БД <{filename}/pages/about.rst#id9>`_
  + Разработка через тестирование (TDD)
  + читабельность и аккуратность кода (PEP8)

* архитектура баз данных (MySQL, SQLite, ZODB, XML, JSON)
* прототипы (рисунок, Balsamiq Mockup, Mockingbird)
